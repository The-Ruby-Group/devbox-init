...
alias src='echo "Reloading terminal..." && exec zsh -l'
...
# Zoxide is a tool to enable `z-style` frecent navigation with support for 
# tab-autocompletion (https://formulae.brew.sh/formula/zoxide)
